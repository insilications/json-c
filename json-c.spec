...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618959939
...
%reconfigure --enable-static --enable-shared  --libdir=/usr/lib32 --build=i686-generic-linux-gnu --host=i686-generic-linux-gnu --target=i686-clr-linux-gnu
make  %{?_smp_mflags}  V=1 VERBOSE=1
popd
