...
Source0  : https://s3.amazonaws.com/json-c_releases/releases/json-c-0.13.tar.gz
...
%prep
%setup -q -n json-c-0.13
pushd ..
cp -a json-c-0.13 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1517677869
...
%files lib32
%defattr(-,root,root,-)
/usr/lib32/libjson-c.so.3
/usr/lib32/libjson-c.so.3.0.1
